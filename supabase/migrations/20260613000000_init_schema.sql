...
-- Description: Initialize core tables, custom roles, dynamic categories, staff tracking, booking schedules, ledgers, and reviews.
...
CREATE TABLE branches (
    ...
    geofence_radius_km DECIMAL(5,2) DEFAULT 0.00,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
-- 8. EMPLOYEE SERVICES CUSTOM OVERRIDES
...
CREATE INDEX idx_bookings_schedule ON bookings (employee_id, scheduled_at, status) WHERE status IN ('confirmed', 'pending_payment');
