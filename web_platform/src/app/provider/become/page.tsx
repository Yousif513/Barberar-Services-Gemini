...
export default function BecomeProviderRedirectPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white flex items-center justify-center font-sans relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-sm w-full mx-4 p-8 rounded-[24px] bg-[#0D1422]/60 border border-[#ECECEC] backdrop-blur-xl shadow-[inset_0_0_20px_rgba(255,255,255,0.01),0_0_30px_rgba(0,0,0,0.5),0_0_40px_rgba(209,175,71,0.05)] text-center transition-all duration-300">
        ...
        <div className="space-y-3">
          ...
          <p className="text-[11px] text-[#667085] font-bold uppercase tracking-widest">
            Redirecting to Join Board...
          </p>
          <p className="text-[11px] text-[#667085] font-semibold tracking-wide" dir="rtl">
