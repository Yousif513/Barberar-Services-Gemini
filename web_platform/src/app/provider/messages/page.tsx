    ...
    <div className="bg-white border border-stone-200 rounded-2xl overflow-hidden shadow-sm flex h-[calc(100vh-12rem)] min-h-[500px]">
      ...
      <div className="w-80 border-r border-stone-200 flex flex-col justify-between bg-stone-50/50 flex-shrink-0">
        <div className="p-4 border-b border-stone-200">
          <h3 className="font-extrabold text-sm text-stone-900 uppercase tracking-wider">Client Inbox</h3>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0 space-y-0.5">
                  ...
                  <p className="text-[9px] text-stone-400 font-extrabold uppercase tracking-wider">{conv.role}</p>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-stone-50/20">
          {(messages[selectedConv.id] || []).map((msg: any, i: number) => {
            ...
            return (
              <div
                key={i}
                className={`flex w-full ${isProvider ? "justify-end" : "justify-start"}`}
              >
                <div
                ...
                >
                  ...
                  <span className={`text-[8px] block mt-1.5 text-right font-medium text-stone-400`}>
                    {msg.time}
                  </span>
                </div>
              </div>
