...
export default function CourierDeliveriesPage() {
  ...
  return (
    <div 
      className={`space-y-8 font-sans bg-[#070B12] text-[#B8C0D4] min-h-screen p-4 md:p-8 rounded-[28px] border border-white/5 shadow-2xl shadow-black/80 relative overflow-hidden`}
      dir={isRTL ? "rtl" : "ltr"}
    >
